...
The app presents application information in a clean, searchable interface, displaying both exact dates and easy-to-understand relative timestamps such as "Installed two days ago" or "Updated four weeks ago." This makes it simple to identify newly installed apps, recently updated apps, and older applications at a glance.
...
* No Data Collection: No analytics, tracking, telemetry, or data harvesting.
